...
" }}}
" nvim-cmp: {{{
call s:HL("CmpItemAbbrMatch", s:blue)
call s:HL("CmpItemAbbrMatchFuzzy", s:blue)
call s:HL("CmpItemAbbrMatchFuzzy", s:blue)
call s:HL("CmpItemKindText", s:xgray7)
call s:HL("CmpItemKindMethod", s:magenta)
call s:HL("CmpItemKindFunction", s:magenta)
call s:HL("CmpItemKindConstructor", s:green)
call s:HL("CmpItemKindField", s:blue)
call s:HL("CmpItemKindVariable", s:blue)
call s:HL("CmpItemKindClass", s:green)
call s:HL("CmpItemKindInterface", s:green)
call s:HL("CmpItemKindValue", s:orange)
call s:HL("CmpItemKindKeyword", s:red)
call s:HL("CmpItemKindSnippet", s:red)
call s:HL("CmpItemKindFile", s:orange)
call s:HL("CmpItemKindFolder", s:orange)
" }}}
" dashboard-nvim: {{{
call s:HL("DashboardHeader", s:orange)
call s:HL("DashboardFooter", s:orange)
call s:HL("DashboardIcon", s:green)
" }}}
" Haskell: {{{
